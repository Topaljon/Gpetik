...
class TranslateView extends GetView<ControllerAudioToText> {
      ...
      child: SafeArea(
        child: IconButton(
          onPressed:() async {
            ...
            response = (await audioApi.audioTranslate(
                audioFile:audioPath
            ))!;
          ...
          icon: const Row(
            ...
            children: [
              Text("translate", style: TextStyle(color: Colors.white, fontSize: 20),),
